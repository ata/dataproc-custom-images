...
python3 generate_custom_image.py \
    ...
    --network projects/kmk-prod/global/networks/kmk-prod \
    --subnetwork projects/kmk-prod/regions/asia-southeast1/subnetworks/kmk-prod-application \
    --metadata install-gpu-agent=true,rapids-runtime=SPARK,cuda-version=11.8.0,spark-rapids-version=23.12.2,driver-version=520.61.05 \
    --no-external-ip
